...
def match_answer(text):
    qa_pairs = {
        ...
        "Ni ibihe bihugu bihana imbibi n’u Rwanda?": "Ni Uganda, Tanzania, Burundi, Repubulika Iharanira Demokarasi ya Congo.",
        "wakora iki": "Nshobora kukumva no kugusubiza.",
        "umusozi muremure mu rwanda ni uwuhe?": "Ni Karisimbi."
    }
